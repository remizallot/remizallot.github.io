...
\usepackage[backend=biber,style=numeric-comp,sorting=ydnt,defernumbers=true,maxnames=99,minnames=99]{biblatex}
...
\begin{center}
  ...
  \small
  \faEnvelope\ \href{mailto:r.zallot@mmu.ac.uk}{r.zallot@mmu.ac.uk} \quad\textbullet\quad
...
\cventry{Research Associate}{Mar 2022 -- Jun 2023}
...
\cventry{Postdoctoral Researcher}{2011 -- 2016}
...
\cventry{PhD, Biochemistry / Plant Biology}{2008 -- 2011}
...
\cventry{Master's, Plant Biology and Biotechnology}{2006 -- 2008}
  {Université de Bordeaux, France}{}

\cventry{Licence, Biochemistry}{2003 -- 2006}
  {Université de Bordeaux, France}{}
...
\item \textbf{Poster presentation} --- 7th Forum of Respiratory Tract Infections, Glasgow, UK. February 2025.
\item \textbf{Invited talk for MMU ECR and PhD Conference} --- Invited talk. Faculty of Science and Engineering, Manchester Metropolitan University, Manchester, UK. September 2024.
\item \textbf{Invited talk} --- National University of Singapore, Singapore. April 2024.
\item \textbf{Invited virtual seminar for the Catalysis Innovation Consortium} --- Invited talk. Catalysis Innovation Consortium, Virtual, USA. March 2024.
\item \textbf{Genomic Enzymology and Enzyme Function Initiative (EFI) Training Workshop} --- Workshop instructor. University of Melbourne, Melbourne, Australia. April 2023.
\item \textbf{Poster presentation} --- Gordon Research Conference on Enzymes, Coenzymes and Metabolic Pathways, Waterville Valley, NH, USA. July 2023.
\item \textbf{Invited talk and EFI workshop} --- National University of Singapore, Singapore. November 2023.
\item \textbf{Invited talk} --- Chinese Academy of Sciences, Institute of Microbiology, Beijing, China. December 2023.
\item \textbf{Invited talk} --- Northwest University, Xi'an, China. December 2023.
\item \textbf{Understanding antimicrobial resistance requires characterising unknown genes} --- Invited talk. Manchester Institute of Biotechnology (MIB) Fellowship days, The University of Manchester, Manchester, UK. January 2022.
\item \textbf{Comparative genomics and genomic enzymology approaches for functional assignment} --- Poster (selected for a short oral presentation). Manchester Institute of Biotechnology (MIB) Annual Science Day, The University of Manchester, Manchester, UK. 2022.
\item \textbf{Similarity Networks and Genome Neighborhood Networks for function assignment} --- Invited talk. School of Chemistry, Cardiff University, Cardiff, UK. April 2021.
\item \textbf{Genomic enzymology web tools for functional assignment} --- Invited talk. Institut Pasteur, Centre of Bioinformatics, Biostatistics and Integrative Biology, Paris, France. June 2019.
...
\item \textbf{Comparative genomics for the identification of unknown genes, enzymes and transporters involved in Queuosine metabolism} --- Invited talk. University of Illinois at Urbana-Champaign, USA. August 2016.
\item \textbf{Production of molecules of interest from plants in Yeast, can comparative genomics help?} --- Invited talk. Université François Rabelais, Tours, France. May 2016.
\item \textbf{Is Streptomyces secondary metabolism regulation involving lipid rafts?} --- Invited talk. Université Paris 11, Orsay, France. May 2016.
...
\item \textbf{Salvage of the thiamin pyrimidine moiety by plant TenA proteins lacking an active site cysteine} --- Invited talk. Plant Biology conference, Portland, OR, USA. July 2014.
